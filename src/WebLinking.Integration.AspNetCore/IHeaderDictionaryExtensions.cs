namespace WebLinking.Integration.AspNetCore
{
    ...
    public static class IHeaderDictionaryExtensions
    {
        ...
        public static IHeaderDictionary AddWebLink(
            this IHeaderDictionary headers,
            IEnumerable<LinkValue> linkValueCollection)
        {
            if (headers == null)
            {
                throw new ArgumentNullException(nameof(headers));
            ...
            headers.Add(
                ...
                new StringValues(
                    string.Join(
                        ",",
                        linkValueCollection.Select(x => x.ToString()))));
            return headers;
        }

        public static IHeaderDictionary AddWebLink(
            this IHeaderDictionary headers,
            params LinkValue[] linkValueCollection)
            => AddWebLink(
                headers,
                linkValueCollection as IEnumerable<LinkValue>);
    }
}
